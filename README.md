...
Tthis project quantitatively evaluates architectural defenses against adversarial attacks. The following objectives were achieved in the attached notebook.
...
(Note: Replace the placeholders below with the actual outputs generated by your Colab notebook).
...
$$PLACEHOLDER: Insert a grid/matplotlib output image showing 5 columns: Original | FGSM | Blurred | Std. AE | U-Net AE$$
...
We evaluate the success of the defenses based on the accuracy of the target classifier on the reconstructed images.
...
Loss and Accuracy Curves (Autoencoder Training)

$$PLACEHOLDER: Insert Matplotlib line graphs showing the training vs validation loss for the Standard AE and U-Net AE$$
